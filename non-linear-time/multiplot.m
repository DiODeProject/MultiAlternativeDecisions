prefix='/Users/joefresna/Google Drive/DiODe/Data/MultiAlternativeDecisions/resultsData/';
geo=1;
maxval_range=3:0.5:5;
logslope_range=0.25:1.25:6.5;
% maxval_range=3;
% logslope_range=0.25;
utility='logHm';
meanValues = -1:0.1:3;
...
suffix=strcat('_rm-1.5_S-8-151_',cost,'_t-37-multiDec_u-');
...
for maxval=maxval_range
    ...
    for logslope=logslope_range
        ...
        title(strcat('ls=',num2str(logslope),' mv=',num2str(maxval)));
        set(gca,'FontSize',13)
        % scaling the axes
        ...
        %fprintf('%f \n',ymax);
        % Fixing the axes
        ymin=0; if geo == true; ymax=37; else; ymax=0.08; end
